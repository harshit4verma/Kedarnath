...
class KedarnathTemple {
  ...
  initMaterials() {
    ...
    // 9. Golden Festive Aarti Fairy Lights Material (as seen in YouTube 360 VR Aarti video)
  ...
  buildTemple() {
    ...
    // Build authentic golden Aarti fairy light strings & festive illumination (YouTube 360 Aarti)
  ...
  // Reconstructs the genuine night illumination seen in the YouTube 360 VR Aarti video
  // and official photographs: golden LED strips outlining Mandapa gables, entrance arch,
  ...
  // Set festive Aarti festival illumination mode (matches YouTube 360 Aarti)
